      ...
      <div class="device-screen">
        <div :class="['pixel-stage', city.backgroundClass]">
          <div class="pixel-stage-top">
            ...
            <div class="pixel-status"><span>PET STATUS</span><strong>{{ pet.mood }}</strong><small>체력 {{ statusSummary.energy }} · 쾌적도 {{ statusSummary.comfort }} · 배고픔 {{ statusSummary.hunger }}</small></div>
          </div>
