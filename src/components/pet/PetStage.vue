...
@media (max-width: 600px) { .pixel-stage-top { flex-direction: column; }.pet-status-anchor { width: 100%; }.pixel-status { width: 100%; }.pixel-location { width: 100%; min-width: 0; white-space: normal; } }
</style>
