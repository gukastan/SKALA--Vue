  ...
  <el-card class="pet-stage-card" shadow="never">
    <div :class="['pixel-stage', city.backgroundClass]">
      ...
      <div class="pixel-scene">
        <div :class="['pixel-puppy', `is-${petState}`]" role="img" :aria-label="`${pet.name} 캐릭터`"><span class="pixel-ear left"></span><span class="pixel-ear right"></span><span class="pixel-puppy-head"><span class="pixel-eye left"></span><span class="pixel-eye right"></span><span class="pixel-muzzle"><span class="pixel-nose"></span><span class="pixel-mouth"></span></span></span><span class="pixel-collar"></span></div>
