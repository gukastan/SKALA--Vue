      ...
      <aside class="weather-control-column">
        ...
        <div class="learning-anchor city-anchor">
          <BaseDashboardCard class="city-list-card" v-loading="isWeatherLoading">
            <div class="section-heading"><div class="city-list-title-row"><h2>여행할 도시</h2><el-tag class="city-count" effect="plain">{{ filteredWeatherList.length }}개 도시</el-tag></div><UnitToggler /></div>
