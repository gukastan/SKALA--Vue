          ...
          <div ref="appScaleShell" class="app-scale-shell">
            <header class="app-top-bar">
              ...
              <div class="learning-toggle" :class="{ 'is-on': learningMode }">
                <span>학습모드</span>
                <el-switch v-model="learningMode" active-text="ON" inactive-text="OFF" aria-label="학습모드 토글" />
              </div>
            </header>
            <div class="route-bar" aria-label="현재 Vue Router 경로"><span>ROUTE MONITOR</span><code>localhost:5173{{ route.path }}</code></div>
